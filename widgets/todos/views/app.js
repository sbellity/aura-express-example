define(['sandbox', '../collections/todos', './todos', 'hbs!../templates/base', 'hbs!../templates/stats', 'i18n!../nls/todos'], function(sandbox, Todos, TodoView, baseTemplate, statsTemplate, lang) {
  'use strict';
